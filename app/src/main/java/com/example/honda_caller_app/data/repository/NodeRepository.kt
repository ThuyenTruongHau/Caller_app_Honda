...
class NodeRepository(
    ...
    /**
     * Lấy danh sách nodes từ advanced API
     * @param owner Username của người dùng
     * @return NetworkResult chứa AdvancedNodesResponse hoặc error message
     */
    suspend fun getAdvancedNodes(owner: String): NetworkResult<AdvancedNodesResponse> {
        return withContext(Dispatchers.IO) {
            try {
                val response = apiService.getAdvancedNodes(owner)
